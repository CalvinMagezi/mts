...
description: Add Pieces for Developers MCP Server as a mts Extension
---
...
This tutorial covers how to add the [Pieces for Developers MCP Server](https://docs.pieces.app/products/mcp/get-started?utm_source=mts&utm_medium=collab&utm_campaign=mcp) as a mts extension to enable interaction with your Pieces Long-Term Memory.
...
1. Code Development with mts:

    Activity: You worked on integrating SSE MCP servers into the mts CLI, making enhancements to handle extensions via schema URLs.
    Description: This task involved modifying code and testing new integrations to support advanced functionalities. It also included interactions with the mts community on Discord for feedback and troubleshooting.

2. Documentation Updates:

    Activity: You updated and managed documentation related to the mts project and MCP integrations.
...
4. Managing and Testing Extensions:
    ...
    Activity: You focused on testing and managing various extensions through the mts platform.
...
:::tip
For more examples of prompts you can use with the Pieces for Developers MCP Server, see the [Pieces MCP prompting guide](https://docs.pieces.app/products/mcp/prompting?utm_source=mts&utm_medium=collab&utm_campaign=mcp).
:::