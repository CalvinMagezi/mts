...
description: Learn how to use mts's built-in Tutorial extension for guided learning
---
...
The Tutorial extension is a built-in feature of mts that provides interactive, step-by-step guidance for learning various aspects of mts and its capabilities. It's designed to help users get comfortable with mts's features through hands-on practice.

The Tutorial extension serves as an interactive learning tool that:
- Provides structured, step-by-step tutorials
- Allows hands-on practice with mts features
...
- **first-game**: Create your first game with mts
...
1. **Ask mts directly**: You can simply ask about a topic you're interested in, and mts will suggest relevant tutorials.

```
( O)> I'd like to learn how to build an extension for mts
```
...
1. mts will guide you step-by-step through the process
...
- **Ask questions**: If something isn't clear, ask mts to explain it further.
...
### mts Prompt
```
I'd like to learn how to build an extension for mts
```
...
- Contribute to the mts community by sharing your experiences
