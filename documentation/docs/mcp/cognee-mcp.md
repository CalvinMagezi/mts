...
description: Add Cognee MCP Server as a mts Extension
---
...
This tutorial covers how to add the [Cognee MCP Server](https://github.com/topoteretes/cognee/tree/main/cognee-mcp) as a mts extension to enable knowledge graph memory capabilities, connecting to over 30 data sources for enhanced context and retrieval.
...
Cognee provides knowledge graph memory capabilities for mts, allowing it to remember and connect information across conversations and documents.
...
> _mts, please cognify this information: "I prefer Python for data analysis and use pandas extensively. My current project involves analyzing customer behavior data." Then search for information about my programming preferences._
