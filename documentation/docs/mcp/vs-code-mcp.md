...
description: Use VS Code MCP Server as a mts Extension for file operations and VS Code integration
unlisted: true
---
...
This tutorial covers how to add the [VS Code MCP Server](https://github.com/block/vscode-mcp) as a mts extension to enable VS Code integration, file operations, and development workflow management.
...
<Tabs groupId="interface">
  ...
  1. [Launch the installer](mts://extension?cmd=npx&arg=-y&arg=vscode-mcp-server&id=vscode-mcp&name=VS%20Code%20MCP&description=VS%20Code%20integration%20and%20file%20operations)
...
The VS Code MCP extension enables mts to interact with your VS Code environment, managing files, projects, and development workflows. 
...
:::note
Every time you start a mts session with the VS Code MCP server enabled, it checks to see if a matching project is open in VS Code. If not, it will prompt you to open the project before proceeding.
:::
...
![session showing mts making updates and VS Code prompting user to accept or reject changes](../assets/guides/vscode-mcp.png)