---
description: Integrate mts with Langfuse to observe performance
---

# Observability with Langfuse

This tutorial covers how to integrate mts with Langfuse to monitor your mts requests and understand how the agent is performing.
...
## Configure mts to Connect to Langfuse

Set the environment variables so that mts (written in Rust) can connect to the Langfuse server.
...
## Run mts with Langfuse Integration

Now, you can run mts and monitor your AI requests and actions through Langfuse.

With mts running and the environment variables set, Langfuse will start capturing traces of your mts activities.
...
![mts trace in Langfuse](https://langfuse.com//images/docs/mts-integration/mts-example-trace.png)
