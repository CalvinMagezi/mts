...
<p className={styles.pageDescription}>
  mts supports several approaches for using different models within a single session, allowing you to optimize for cost, performance, and task specialization. Strategies range from manual or turn-based model selection to dynamic, context-aware switching.
</p>
...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    <Card
      ...
      link="/blog/2025/06/16/multi-model-in-mts"
    />
    <Card
...
<VideoCarousel
  ...
  videos={[
    ...
    { 
      ...
      description: 'Using lead/worker mode to add features to the mts docs in real time',
      duration: '9:36'
    }
  ]}
/>
