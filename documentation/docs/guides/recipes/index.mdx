...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    ...
    <Card 
      ...
      description="Complete technical reference for creating and customizing recipes in mts via the CLI."
      link="/docs/guides/recipes/recipe-reference"
    />
    <Card 
      title="mts Recipes Tutorial"
      description="Learn how to create and use mts recipes with prompts, parameters, MCP servers, and more."
    ...
    <Card 
      ...
      description="Learn how to save, organize, and find your mts recipes for easy access and reuse."
...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    <Card 
      ...
      description="Interactive tool that creates a shareable mts recipe URL that others can use to launch a session with your predefined settings."
...
<VideoCarousel
  ...
  videos={[
    { 
      ...
      title: 'Advanced Tips for Recipes/Subrecipes in mts',
      description: 'Advanced tips for using recipes and subrecipes in mts',
      duration: '10:07'
    },
    { 
      type: 'iframe', 
      src: 'https://youtube.com/embed/gvg7DomaJuA',
      title: 'Headless mts, Scheduling a Parallel-Subagent Recipe',
