...
hide_title: true
description: Manage your session lifecycle and ongoing interactions with mts
---
...
<p className={styles.pageDescription}>
  Sessions are your continuous interactions with mts. Each session maintains context and conversation history, enabling mts to understand your ongoing work and provide relevant assistance.
</p>
...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    ...
    <Card 
      ...
      description="Discover features you can use to share information and communicate with mts during sessions."
...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    <Card
      title="6 Essential Tips for Working with mts"
    ...
    <Card
      ...
      description="Learn how context windows, tokens, and mts help you manage memory and long conversations."
