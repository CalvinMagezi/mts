...
```bash
export MTS_EDITOR_API_KEY="your-api-key-here"
...
export MTS_EDITOR_MODEL="claude-3-5-sonnet-20241022"
```

**Morph:**
```bash
export MTS_EDITOR_API_KEY="sk-..."
export MTS_EDITOR_HOST="https://api.morphllm.com/v1"
export MTS_EDITOR_MODEL="morph-v0"
```

**Relace:**
```bash
export MTS_EDITOR_API_KEY="rlc-..."
export MTS_EDITOR_HOST="https://instantapply.endpoint.relace.run/v1/apply"
export MTS_EDITOR_MODEL="auto"
```
...
1. **Configuration Check**: mts checks if all three environment variables are properly set and non-empty.

2. **With AI Enabled**: If configured, mts sends the original code and your requested change to the configured AI model for processing.
