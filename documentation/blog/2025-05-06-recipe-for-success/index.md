...
[MTS](/) is a local, open source AI agent that follows the structure of MCP.
...
* **MCP Servers** – a package of tools, data, or prompts in a structured format. In the MTS ecosystem, we refer to MCP servers as extensions.

This architecture allows MTS to discover tools dynamically, understand how to use them, and orchestrate complex workflows across multiple systems.

---

## MTS as an Orchestrator

When a user prompts MTS to "Gather all discussions about the authentication bug from last week," MTS orchestrates the operation. It coordinates tools, manages execution, and adapts on the fly by:
...
When something breaks, MTS doesn't panic; it pivots. For example, MTS might determine:
...
Similarly, MTS is a forward-looking AI agent with a solution for scaling knowledge through [recipes](/docs/guides/recipes/session-recipes). Recipes are complete orchestrations you can rerun, remix, or share, passing on knowledge to anyone who needs it.

Sharing a prompt doesn't always recreate the experience; AI is non-deterministic, and people may not have the same extensions or context configured. Recipes solve this by packaging your entire MTS workflow: the extensions, the setup, the goal, and example activities.
...
> [Create a 404-style portfolio page with MTS](mts://recipe?config=)

:::note
The link above opens in the MTS Desktop app. If you don't have it installed yet, grab it [here](/docs/getting-started/installation).
:::
...
<head>
  ...
  <meta property="og:image" content="https://block.github.io/mts/assets/images/cookingwithmts-9114cf03cec76df4792fc58361ebe20b.png" />
  ...
  <meta name="twitter:image" content="https://block.github.io/mts/assets/images/cookingwithmts-9114cf03cec76df4792fc58361ebe20b.png" />
</head>