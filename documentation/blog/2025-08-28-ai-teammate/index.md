---
title: "When AI Becomes Your New Team Member: The Story of MTS Janitor"
description: "How an engineering team is trialling autonomous AI-powered technical debt cleanup"
authors: 
    - angie
---

![blog banner](mts-janitor.png)
...
With the serendipitous launch of MTS recipes around the same time, the team wondered could a dedicated recipe aid this effort? [Gemma Barlow](https://www.linkedin.com/in/gemmakbarlow/), a newer iOS engineer on the team, wanted to find out. 
...
Gemma's first move was to utilize an existing system of `.mdc`, `.mtshints` and other symlinked context documents to capture how to safely remove feature flags from the repository.
...
But instead, she utilized MTS recipes to create **MTS Janitor**.


MTS Janitor acts as new AI team member whose responsibility is to tidy up the code after we're done experimenting. It was heavily inspired by existing [MTS recipes](/recipes/detail/?id=clean-up-feature-flag) and internal discussions and experimentation occurring elsewhere in Block. Here's how it is run:

```bash
mts run \
--recipe .mts/recipes/mts-janitor-flag-removal.yaml \
...
Recipes like MTS Janitor represent a fundamental shift in how we think about AI in software development. They can be deployed to:
...
Teams at Block are confident that MTS Janitor will be of assistance in production scale cleanup work.
...
The success of MTS Janitor opens up fascinating possibilities. What other forms of technical debt could benefit from this approach? What other "AI team members" could we build to handle routine but knowledge intensive work?
...
<head>
  <meta property="og:title" content="When AI Becomes Your New Team Member: The Story of MTS Janitor" />
  <meta property="og:type" content="article" />
  <meta property="og:url" content="https://block.github.io/mts/blog/2025/08/28/ai-teammate" />
  <meta property="og:description" content="How an engineering team is trialling autonomous AI-powered technical debt cleanup" />
  <meta property="og:image" content="https://block.github.io/mts/assets/images/mts-janitor-129889884d9265d001fe12cbfde03d57.png" />
  <meta name="twitter:card" content="summary_large_image" />
  <meta property="twitter:domain" content="block.github.io/mts" />
  <meta name="twitter:title" content="When AI Becomes Your New Team Member: The Story of MTS Janitor" />
  <meta name="twitter:description" content="How an engineering team is trialling autonomous AI-powered technical debt cleanup" />
  <meta name="twitter:image" content="https://block.github.io/mts/assets/images/mts-janitor-129889884d9265d001fe12cbfde03d57.png" />
</head>