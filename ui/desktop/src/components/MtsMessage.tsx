...
export default function MtsMessage({
  sessionId,
  messageHistoryIndex,
  message,
  messages,
  ...
  return (
    <div className="mts-message flex w-[90%] justify-start min-w-0">
            ...
            <div className="relative flex flex-col w-full">
              <div className="flex flex-col gap-3">
                {toolRequests.map((toolRequest) => (
                  <div className="mts-message-tool" key={toolRequest.id}>
