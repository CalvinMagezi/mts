...
/// Represents available GCP Vertex AI models for mts.
///
...
/// Represents available versions of the Claude model for mts.
#[derive(Debug, Clone, PartialEq, Eq)]
...
/// Represents available versions of the Gemini model for mts.
#[derive(Debug, Clone, PartialEq, Eq)]
