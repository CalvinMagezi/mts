use mts::agents::extension::Envs;
use mts::agents::extension::ToolInfo;
use mts::agents::ExtensionConfig;
...
use mts::permission::permission_confirmation::PrincipalType;
use mts::providers::base::{ConfigKey, ModelInfo, ProviderMetadata, ProviderType};
use mts::session::{Session, SessionInsights, SessionType};
use rmcp::model::{
...
use mts::config::declarative_providers::{
...
#[openapi(
    paths(
        ...
        super::routes::config_management::generate_commit_message,
        super::routes::config_management::generate_diagram,
        ...
        super::routes::search::search_files,
        super::routes::search::search_filenames,
        super::routes::search::replace_in_files,
    ),
    components(schemas(
        ...
        super::routes::config_management::GenerateCommitMessageRequest,
        super::routes::config_management::GenerateCommitMessageResponse,
        super::routes::config_management::GenerateDiagramRequest,
        super::routes::config_management::GenerateDiagramResponse,
        ...
        Conversation,
        IconSchema,
        mts::session::extension_data::ExtensionData,
        ...
        mts::recipe::Author,
        mts::recipe::Settings,
        mts::recipe::RecipeParameter,
        mts::recipe::RecipeParameterInputType,
        mts::recipe::RecipeParameterRequirement,
        mts::recipe::Response,
        mts::recipe::SubRecipe,
        mts::agents::types::RetryConfig,
        mts::agents::types::SuccessCheck,
        ...
        super::routes::search::SearchFilesRequest,
        super::routes::search::SearchFilesResponse,
        super::routes::search::SearchMatch,
        super::routes::search::SearchFilenamesRequest,
        super::routes::search::SearchFilenamesResponse,
        super::routes::search::FilenameMatch,
        super::routes::search::ReplaceRequest,
        super::routes::search::ReplaceResponse,
    ))
)]
pub struct ApiDoc;
