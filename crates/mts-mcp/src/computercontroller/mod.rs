...
impl ComputerControllerServer {
    pub fn new() -> Self {
        ...
        // - macOS/Linux: ~/.cache/mts/computer_controller/
        // - Windows:     ~\AppData\Local\Block\mts\cache\computer_controller\
        ...
        Self {
            ...
            http_client: Client::builder().user_agent("mts/1.0").build().unwrap(),
            instructions,
            system_automation,
        }
    }
    ...
    fn get_info(&self) -> ServerInfo {
        ServerInfo {
            server_info: Implementation {
                name: "mts-computercontroller".to_string(),
